            ...
            previewItems.map((item) => {
              ...
              return (
                <div
                  ...
                  className={cn(
                    "p-3.5 transition-colors cursor-pointer flex gap-3 relative group",
                    isUnread
                ...
                >
                  <div
                    className={cn(
                      "size-9 rounded-full flex items-center justify-center shrink-0 border border-border/40",
                  ...
                  <div className="flex-1 min-w-0 space-y-1">
                    <div className="flex items-start justify-between gap-1.5">
                      <span className={cn("text-xs leading-snug line-clamp-1", isUnread ? "font-bold text-foreground" : "font-medium text-foreground/90")}>
                        {item.title}
                      </span>
                      <Badge className={cn("text-[9px] px-1.5 py-0 border shrink-0 font-medium", visual.badgeClassName)}>
                        {visual.label}
                      </Badge>
                    </div>
