...
import { PeerReviewModal } from "@/features/student/assessment/components/peer-review-modal";
import type { PeerReviewCandidate, PeerReviewRubric } from "@/features/student/assessment/types/peer-review";

const mutateAsync = vi.fn();

vi.mock("@/features/student/assessment/hooks/use-peer-review", async () => {
  const actual = await vi.importActual<typeof import("@/features/student/assessment/hooks/use-peer-review")>("@/features/student/assessment/hooks/use-peer-review");
  return {
    ...actual,
    useSubmitPeerReview: () => ({
      mutateAsync,
