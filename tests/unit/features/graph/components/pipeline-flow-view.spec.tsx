...
import { PipelineFlowView } from "@/features/graph/components/pipeline-flow-view";
import { PipelineMatrixTable } from "@/features/graph/components/pipeline-matrix-table";
import { PipelineTaskInspector } from "@/features/graph/components/pipeline-task-inspector";
import { PipelineEmptyState } from "@/features/graph/components/pipeline-empty-state";
import type { PipelineLane, PipelineTask } from "@/features/graph/types/pipeline";
...
describe("pipeline UI", () => {
  ...
  fptTest(
    ...
    () => {
      const srcBase = resolve(__dirname, "../../../../../src/features/graph/components");
      const files = [
        resolve(srcBase, "pipeline-flow-view.tsx"),
        resolve(srcBase, "pipeline-matrix-table.tsx"),
        resolve(srcBase, "pipeline-task-inspector.tsx"),
        resolve(srcBase, "pipeline-stats-bar.tsx"),
        resolve(srcBase, "graph-filter-bar.tsx"),
        resolve(srcBase, "../hooks/use-pipeline-graph-data.ts"),
        resolve(srcBase, "../lib/pipeline-mapper.ts"),
      ];
