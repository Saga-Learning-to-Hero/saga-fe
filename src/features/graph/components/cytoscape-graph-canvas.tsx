...
export function CytoscapeGraphCanvas({
  ...
  return (
    <div className="relative w-full h-[640px] sm:h-[700px] lg:h-[740px] rounded-3xl border border-border/90 bg-linear-to-b from-card/95 via-card/80 to-card/95 backdrop-blur-md overflow-hidden shadow-md">
      ...
      {isLegendOpen ? (
        <div className="absolute top-4 left-4 p-4 rounded-2xl bg-card/95 backdrop-blur-md border border-border/80 shadow-lg text-xs space-y-2.5 pointer-events-auto max-w-xs animate-in fade-in-0 duration-200">
          ...
          {isSNAGraph ? (
            ...
            <div className="flex flex-col gap-1.5 font-medium text-[11px]">
              <div className="flex items-center gap-2">
                <span className="w-3.5 h-3.5 rounded-full bg-blue-600 border border-blue-200 shrink-0" />
                <span><strong className="text-foreground font-mono">(:Student)</strong> Sinh viên</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-3.5 h-3 rounded-xs bg-emerald-600 border border-emerald-200 shrink-0" />
                <span><strong className="text-foreground font-mono">(:JiraTask)</strong> Task Jira</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-3.5 h-2.5 rounded-xs bg-purple-600 border border-purple-200 shrink-0" />
                <span><strong className="text-foreground font-mono">(:Commit)</strong> Git Commit</span>
              </div>
              <div className="pt-1.5 border-t border-border/60 space-y-1">
                <div className="text-[10px] text-muted-foreground font-mono flex items-center gap-1.5">
                  <span className="w-2.5 h-0.5 bg-emerald-500 rounded-full" />
        ...
        <button
          ...
          className="absolute top-4 left-4 flex items-center gap-1.5 px-3 py-2 rounded-2xl bg-card/95 backdrop-blur-md border border-border/80 shadow-md text-xs font-bold text-foreground hover:bg-muted cursor-pointer transition-all pointer-events-auto"
