...
import { useProjectGraph, getProjectGraphQueryKey } from "@/features/graph/hooks/use-project-graph";
import { ProjectGraphService } from "@/features/graph/api/project-graph-service";
import type { GraphSubgraphFilterParams } from "@/features/graph/types/graph";

vi.mock("@/features/graph/api/project-graph-service", () => ({
  ProjectGraphService: {
